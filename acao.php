...
if ($acao =='Salvar'){
    ...
    if (empty($_POST["nome"])) {
        ...
        if ($id == 0){
            ...
            file_put_contents("https://63517d1b3e9fa1244e600a79.mockapi.io/Users",json_encode($dados));
...
function get_dados(){
    ...
    //if (file_exists("banco.json")){
        $conteudo =file_get_contents("https://63517d1b3e9fa1244e600a79.mockapi.io/Users");
